...
/// {@endtemplate}
final class aside<A, B> extends DomComponent<A, B> {
  const aside([super.first, super.second]);
...
/// {@endtemplate}
final class body<A, B> extends DomComponent<A, B> {
  const body([super.first, super.second]);
...
/// {@endtemplate}
final class footer<A, B> extends DomComponent<A, B> {
...
/// {@endtemplate}
final class head<A, B> extends DomComponent<A, B> {
  const head([super.first, super.second]);
...
/// {@endtemplate}
final class header<A, B> extends DomComponent<A, B> {
...
/// {@endtemplate}
final class html<A, B> extends DomComponent<A, B> {
  const html([super.first, super.second]);
...
/// {@endtemplate}
final class title<A, B> extends DomComponent<A, B> {
  const title([super.first, super.second]);
...
/// {@endtemplate}
final class h1<A, B> extends DomComponent<A, B> {
  const h1([super.first, super.second]);
...
/// {@endtemplate}
final class h2<A, B> extends DomComponent<A, B> {
  const h2([super.first, super.second]);
...
/// {@endtemplate}
final class h3<A, B> extends DomComponent<A, B> {
  const h3([super.first, super.second]);
...
/// {@endtemplate}
final class h4<A, B> extends DomComponent<A, B> {
  const h4([super.first, super.second]);
...
/// {@endtemplate}
final class h5<A, B> extends DomComponent<A, B> {
  const h5([super.first, super.second]);
...
/// {@endtemplate}
final class h6<A, B> extends DomComponent<A, B> {
  const h6([super.first, super.second]);
...
/// {@endtemplate}
final class main_<A, B> extends DomComponent<A, B> {
  const main_([super.first, super.second]);
...
/// {@endtemplate}
final class nav<A, B> extends DomComponent<A, B> {
...
/// {@endtemplate}
final class section<A, B> extends DomComponent<A, B> {
...
/// {@endtemplate}
final class blockquote<A, B> extends DomComponent<A, B> {
  const blockquote([super.first, super.second]);
...
/// {@endtemplate}
final class dd<A, B> extends DomComponent<A, B> {
  const dd([super.first, super.second]);
...
/// {@endtemplate}
final class dl<A, B> extends DomComponent<A, B> {
  const dl([super.first, super.second]);
...
/// {@endtemplate}
final class dt<A, B> extends DomComponent<A, B> {
  const dt([super.first, super.second]);
...
/// {@endtemplate}
final class ul<A, B> extends DomComponent<A, B> {
  const ul([super.first, super.second]);
...
/// {@endtemplate}
final class ol<A, B> extends DomComponent<A, B> {
  const ol([super.first, super.second]);
...
/// {@endtemplate}
final class li<A, B> extends DomComponent<A, B> {
  const li([super.first, super.second]);
...
/// {@endtemplate}
final class hr<A, B> extends DomComponent<A, B> {
  const hr([super.first, super.second]);

  @override
  String get tag => 'hr';

  // Even if someone passes children accidentally, an <hr> shouldn't render them.
  @override
...
/// {@endtemplate}
final class p<A, B> extends DomComponent<A, B> {
  const p([super.first, super.second]);
...
/// {@endtemplate}
final class pre<A, B> extends DomComponent<A, B> {
  const pre([super.first, super.second]);

  @override
  String get tag => 'pre';
}

final class style<A, B> extends DomComponent<A, B> {
  const style([super.first, super.second]);

  @override
  String get tag => 'style'; // Fixed from 'pre'
}
